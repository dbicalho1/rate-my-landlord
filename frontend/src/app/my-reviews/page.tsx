...
import { reviewsAPI, isAuthenticated, type Review } from "@/lib/api";
...
export default function MyReviewsPage() {
  ...
  useEffect(() => {
    ...
    try {
      if (!isAuthenticated()) {
        const next = encodeURIComponent('/my-reviews');
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
        <Reveal>
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold text-black">My Reviews</h1>
            <p className="mt-2 text-lg text-gray-600">Manage the reviews you've submitted</p>
          </div>
        </Reveal>
        ...
        <TopAlert
          ...
          description={
            error ? (
              <>
                <p>{error}</p>
                <button onClick={fetchMyReviews} className="mt-2 text-sm font-medium underline">
                  Try again
                </button>
              </>
            ) : undefined
          ...
          <>
            ...
            {reviews.length > 0 ? (
                  ...
                  <Reveal key={review.id} delay={idx * 40}>
                    <div className="bg-white rounded-lg border p-6 hover:shadow-lg transition-shadow border-gray-200">
                      ...
                      <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                        <span>
                          {review.is_anonymous ? 'Anonymous' : review.author_email || 'You'}
                        </span>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">You haven't submitted any landlord reviews.</p>
                <Link
                  href="/submit"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-md text-sm font-semibold text-white bg-[#00ac64] hover:bg-[#008a52] transition-colors"
                >
